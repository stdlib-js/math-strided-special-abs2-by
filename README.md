...
```javascript
import abs2By from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-abs2-by@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-abs2-by/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-special-abs2-by/actions/workflows/test.yml?query=branch:v0.2.2
